...
module.exports = {
    'france':[
        {
            'dialog': `Let's go to France with Appu!!`
        ...
        },
        {
            ...
            'dialog': `appu and friends say <audio src="${CountryRelated.france.CLIP2}"/> `
                + `appu and friends are talking to waiter at local restaurant`
                + ` <audio src="${CountryRelated.france.CLIP3}"/> and then they start to climb the eiffel tower by stairs `
                 + ` <audio src="${CountryRelated.france.CLIP4}"/> now appu teleports himself and his friends to the big building.`
                 + ` do you know what that big building is called?`,
            'response': `notre dame`,
        },
        {
            'wrongRes': `lets see what appu says`,
            'correctRes': `lets see what appu says`,
    ...
    'india':[
        {
            'dialog': `Let's go to India with Appu and Friends.` + `<audio src="${CountryRelated.india.CLIP0}"/>`
    ...
    'australia':[
        {
            ...
            Appu and Friends!` + `<audio src="${CountryRelated.australia.CLIP2}"/>` + `Woohoo we reached 
        ...
        },
        {
            ...
            with Appu. shall we? ` + `<audio src="${CountryRelated.australia.CLIP5}"/>` + ` Woahh !!! I 
            ...
            about, do you? Let's see if Appu finds out.` + `<audio src="${CountryRelated.australia.CLIP6}"/>` 
        ...
        },
        {
            ...
            coral reef. It would be so much fun to visit there with appu? ` + 
            `<audio src="${CountryRelated.australia.CLIP8}"/> ` + `So, finally Appu found out what is down 
            under. Let's see the reef with Appu now.` + `<audio src="${CountryRelated.australia.CLIP9}"/>`,
            'end': true,
        },
    ],
    'diwali':[
        {
            'dialog': `Neena came to her animal friends wearing a beautiful Indian dress and with some sweets.` 
    ...
    'christmas':[
        {
            'dialog': `Neena brought a snow globe to show her animal friends.` 
        ...
        },
        {
            ...
            + `Would you like to sing the Christmas song, Jingle Bells?`,
            'response': `yes`,
        },
        {
            'correctRes': `Great! Sing along.`,
    ...
    'Eid Ul Fitr':[
        {
            'dialog': `Neena got her animal friends different types of dishes.` 
